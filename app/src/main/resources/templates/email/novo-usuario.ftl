...
<!-- HEADER -->
<table class="head-wrap" style="background-color:#f3f3f3">
	<tr>
		<td></td>
		<td class="header container" >
				...
				<div class="content">
					<table>
						<tr>
							<td>INOVA CONTABIL</td>
							<td align="right"><h6 class="collapse">Novo Usuário</h6></td>
						</tr>
					</table>
				</div>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Olá, ${nome}</h3>
						<p class="lead">Você foi adicionado no sistema Inova Contabil.</p>
						<p>Confirme sua conta e cadastre sua senha</p>

						<div class="callout">
							Nome: <b>${nome}</b><br/>
							E-mail: <b>${email}</b><br/>
							Contabilidade: <b>${contabilidade}</b><br/>
						...
						<div style="text-align:center">
							<a href="${link}" class="botao">
								Cadastre sua senha. Clique aqui!!
							</a>
						</div>
